...
class WCD_Plugin {
	...
	public static function init() {
		...
		add_filter( 'wcd_eligible_subtotal', array( 'WCD_Exclusion', 'filter_eligible_subtotal' ), 10, 2 );
		add_filter( 'wcd_available_rules', array( 'WCD_Exclusion', 'filter_available_rules' ), 10, 2 );
