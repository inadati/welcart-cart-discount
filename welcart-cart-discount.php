...
require_once WCD_PLUGIN_DIR . 'includes/class-wcd-exclusion-calculator.php';
require_once WCD_PLUGIN_DIR . 'includes/class-wcd-exclusion-settings.php';
require_once WCD_PLUGIN_DIR . 'includes/class-wcd-exclusion.php';
